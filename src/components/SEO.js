...
class SEO extends Component {
  render() {
    ...
    if (postSEO || pageSEO || gallerySEO) {
      title = 'Lilian Cazabet' + ' ' + '-' + ' ' + postNode.title
    ...
    return (
      <Helmet>
        ...
        <meta name="keywords" content="lilian,cazabet,lilian-cazabet,photo,photographie,photographe,photo,portfolio" />
        ...
        <meta name="google-site-verification" content="gkmSu2q2-bF_AyoxfL76fLtPCu8JTHNcTnY34v1s7tI" />
      </Helmet>
    )
  }
}
